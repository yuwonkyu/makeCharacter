    ...
    <div className="relative min-h-screen w-full">
      ...
      <button
        className="z-10 absolute left-1/2 bottom-10 -translate-x-1/2 px-8 py-4 rounded-[16px] text-2xl font-bold shadow-lg border-none
          md:top-10 md:right-10 md:left-auto md:bottom-auto md:-translate-x-0 text-gray-1
          hover:opacity-90 transition-opacity duration-300 ease-in-out bg-gradient-blue-custom"
